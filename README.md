...
40 swipes, starting at 18, drawing from its own thousand-card pool and **never
...
| time per minor swipe | 1 month | 4 months |
| ends when | you die or go broke | you die, go broke, **or** hit 40 swipes |
...
counts `swipe 12 of 40` so the ending is never a surprise.
...
It also reports the numbers the 40-swipe cap was tuned against, including an

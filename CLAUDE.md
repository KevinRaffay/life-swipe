...
| `server/name-pool.json` | 993 names across 49 origins, generated from SSA birth records, with era, gender, national births, per-region frequency and an `active` flag. Data only. |
...
| `server/name-pool.json` | data only: 993 names across 49 origins, generated from SSA birth records, with era, gender, national births, per-region frequency and an `active` flag. |
